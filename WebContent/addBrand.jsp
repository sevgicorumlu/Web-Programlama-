        ...
        <form method="post" action="AddBrand" >
            ...
            <div class="desktop-nav-tabs d-none d-sm-none d-lg-block">
                <ul class="nav nav-tabs product-tabs-select">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="pill" href="#general_info">Marka Ekle</a>
                    </li>
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="general_info">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control char-textarea" name="marka" required maxlength="100"
                                   data-length="100" id="marka" placeholder="Marka"   />
