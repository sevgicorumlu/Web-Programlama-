        ...
        <form method="post" action="CategoryUpdate" >
            ...
            <div class="desktop-nav-tabs d-none d-sm-none d-lg-block">
                <ul class="nav nav-tabs product-tabs-select">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="pill" href="#general_info">Kategori Düzenle</a>
                    </li>
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="general_info">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control char-textarea" name="categoryImage" id="categoryImage" placeholder="Kategori Foto"
                            value="<%=request.getParameter("categoryImage") %>"/>
                        </div>
                    </div>
                    
                     <div class="form-group row">
                        <label for="categoryName" class="col-sm-2 col-form-label">Kategori <span class="required-input">*</span>
                        </label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control char-textarea" name="categoryName" required maxlength="100"
                                   data-length="100" id="categoryName" placeholder="Kategori Adı" value="<%=request.getParameter("categoryName") %>"  />
